    ...
    <div id="snipe-ai-chat-panel" class="snipe-ai-chat-panel" hidden role="dialog" aria-label="AI assistant">
        <div class="snipe-ai-chat-header">
            ...
            <button type="button" id="snipe-ai-chat-close" class="snipe-ai-chat-close"
                aria-label="{{ trans('general.cancel') }}">&times;</button>
        </div>
        ...
        <form id="snipe-ai-chat-form" class="snipe-ai-chat-form">
            ...
            <textarea id="snipe-ai-chat-input" rows="4" maxlength="8000" required placeholder="Ask about Snipe-IT or ITAM…"></textarea>
            <button type="submit" class="btn btn-primary btn-sm" id="snipe-ai-chat-send">Send</button>
        </form>
        <p class="snipe-ai-chat-hint text-muted small">Try `ops help` — requestable search, request asset, links open in
            a new tab.</p>
    </div>
</div>
